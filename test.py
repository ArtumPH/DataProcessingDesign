import sys
from PyQt6.QtWidgets import QApplication, QMainWindow, QTableWidget, QTableWidgetItem, QVBoxLayout, QWidget, QPushButton, QGraphicsView, QGraphicsScene, QFileDialog, QMessageBox, QListWidget, QComboBox, QHBoxLayout, QTextEdit, QHeaderView, QGraphicsItem
...
class ZoomableTable(QGraphicsView):
    def __init__(self, table_widget):
        ...
        self.scene.addWidget(self.table_widget)
...
if __name__ == '__main__':
    ...
    # Create a zoomable table and set it as the central widget
    zoomable_table = ZoomableTable(window.table_widget)
    window.setCentralWidget(zoomable_table)
